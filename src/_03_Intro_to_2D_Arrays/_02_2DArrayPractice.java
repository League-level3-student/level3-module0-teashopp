...
public class _02_2DArrayPractice {
	 ...
	 */
	public String[][] test2() {
		String[][] StringArray2D = new String[2][4];
	...
	public Boolean[][] test3() {
		Boolean[][] BoolArray2D = new Boolean[5][2];
		return BoolArray2D;
	}
	 ...
	 * 
	 * robot0 robot1 robot2 robot3 robot4 robot5 robot6 robot7
	 * 
	 * Show your teacher the grid you created
	 */
